        ...
        <DialogContent className="w-[95%] max-w-md mx-auto">
          <DialogHeader>
            <DialogTitle className="text-lg sm:text-xl">
              {editMode ? "Editar/Excluir Ensaio" : "Adicionar Ensaio"}
            </DialogTitle>
          </DialogHeader>
          {editMode && eventoSelecionado ? (
            ...
            >
              <div>
                <label className="block text-sm font-medium text-sm sm:text-base">Título</label>
                <Input
              ...
              <div>
                <label className="block text-sm font-medium text-sm sm:text-base">Descrição</label>
                <Input
              ...
              <div>
                <label className="block text-sm font-medium text-sm sm:text-base">Horário</label>
                <Input
                  type="time"
              ...
              <div className="flex gap-2 justify-end">
                <Button type="submit" className="text-sm sm:text-base px-3 sm:px-4 py-2">Salvar</Button>
                <Button
                  type="button"
                  className="bg-red-500 hover:bg-red-600 cursor-pointer text-sm sm:text-base px-3 sm:px-4 py-2"
                  variant="destructive"
                  onClick={async () => {
